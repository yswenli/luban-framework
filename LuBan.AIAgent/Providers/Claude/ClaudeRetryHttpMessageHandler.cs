...
/// <summary>
/// Claude 重试 HTTP 消息处理器，用于处理 Claude 请求的重试逻辑
/// </summary>
public class ClaudeRetryHttpMessageHandler : DelegatingHandler
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        while (true)
        {
            ...
            {
                // 设置认证头
                currentRequest.Headers.Add("x-api-key", _options.ApiKey);
                currentRequest.Headers.Add("anthropic-version", _options.Version);
