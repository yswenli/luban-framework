...
/// <summary>
/// GLM 重试 HTTP 消息处理器，用于处理 GLM 请求的重试逻辑
/// </summary>
public class GLMRetryHttpMessageHandler : DelegatingHandler
{
    /// <summary>
    /// GLM 配置选项
    /// </summary>
    ...
    /// 日志记录器
    /// </summary>
    private readonly ILogger<GLMRetryHttpMessageHandler>? _logger;
    ...
    public GLMRetryHttpMessageHandler(GLMOptions options, ILogger<GLMRetryHttpMessageHandler>? logger = null)
    {
        _options = options;
        _logger = logger;
    }
