...
/// <summary>
/// MiMo 重试 HTTP 消息处理器，用于处理 MiMo 请求的重试逻辑
/// </summary>
public class MiMoRetryHttpMessageHandler : DelegatingHandler
{
    /// <summary>
    /// MiMo 配置选项
    /// </summary>
    ...
    /// 日志记录器
    /// </summary>
    private readonly ILogger<MiMoRetryHttpMessageHandler>? _logger;
    ...
    public MiMoRetryHttpMessageHandler(MiMoOptions options, ILogger<MiMoRetryHttpMessageHandler>? logger = null)
    {
        _options = options;
        _logger = logger;
    }
