...
/// <summary>
/// Doubao 重试 HTTP 消息处理器，用于处理 Doubao 请求的重试逻辑
/// </summary>
public class DoubaoRetryHttpMessageHandler : DelegatingHandler
{
    /// <summary>
    /// Doubao 配置选项
    /// </summary>
    ...
    /// 日志记录器
    /// </summary>
    private readonly ILogger<DoubaoRetryHttpMessageHandler>? _logger;
    ...
    public DoubaoRetryHttpMessageHandler(DoubaoOptions options, ILogger<DoubaoRetryHttpMessageHandler>? logger = null)
    {
        _options = options;
        _logger = logger;
    }
