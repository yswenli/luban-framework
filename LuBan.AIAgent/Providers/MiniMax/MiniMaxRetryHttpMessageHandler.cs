...
/// <summary>
/// MiniMax 重试 HTTP 消息处理器，用于处理 MiniMax 请求的重试逻辑
/// </summary>
public class MiniMaxRetryHttpMessageHandler : DelegatingHandler
{
    /// <summary>
    /// MiniMax 配置选项
    /// </summary>
    ...
    /// 日志记录器
    /// </summary>
    private readonly ILogger<MiniMaxRetryHttpMessageHandler>? _logger;
    ...
    public MiniMaxRetryHttpMessageHandler(MiniMaxOptions options, ILogger<MiniMaxRetryHttpMessageHandler>? logger = null)
    {
        _options = options;
        _logger = logger;
    }
