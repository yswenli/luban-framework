...
/// <summary>
/// DeepSeek聊天模型提供者，用于与DeepSeek API进行交互
/// </summary>
public class DeepSeekChatModelProvider : OpenAICompatibleProviderBase
{
    /// <summary>
    /// 提供者名称
    /// </summary>
    ...
    public DeepSeekChatModelProvider(HttpClient httpClient, Microsoft.Extensions.Options.IOptions<DeepSeekOptions> options, ILogger<DeepSeekChatModelProvider>? logger = null)
    ...
    protected override string GetBaseUrl()
        => _options.BaseUrl ?? "https://api.deepseek.com/v1/";
}