...
/// <summary>
/// Qwen 重试 HTTP 消息处理器，用于处理 Qwen 请求的重试逻辑
/// </summary>
public class QwenRetryHttpMessageHandler : DelegatingHandler
{
    /// <summary>
    /// Qwen 配置选项
    /// </summary>
    ...
    /// 日志记录器
    /// </summary>
    private readonly ILogger<QwenRetryHttpMessageHandler>? _logger;
    ...
    public QwenRetryHttpMessageHandler(QwenOptions options, ILogger<QwenRetryHttpMessageHandler>? logger = null)
    {
        _options = options;
        _logger = logger;
    }
