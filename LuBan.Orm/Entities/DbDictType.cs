...
/// 系统字典类型表
/// </summary>
[SugarTable("db_dict_type", "系统字典类型表")]
[SysTable]
public class DbDictType : EntityBase
{
    /// <summary>
    /// 名称
    /// </summary>
    ...
    /// 字典值集合
    /// </summary>
    [Navigate(NavigateType.OneToMany, nameof(DbDictData.DictTypeId)), JsonIgnore]
    public List<DbDictData> Children { get; set; }
}