...
*文件名： EnumErrorCode
*版本号： V1.0.0.0
*唯一标识：fea8bb34-aeb2-4ad4-b9d6-e66f4159f740
*当前的用户域：WALLE
*创建人： yswenli
*电子邮箱：yswenli@outlook.com
*创建时间：2023/12/4 15:22:36
*描述：系统错误码
*=================================================
*修改标记
*修改时间：2023/12/4 15:22:36
*修改人： yswenli
*版本号： V1.0.0.0
*描述：系统错误码
*
...
public enum EnumErrorCode
{
    ...
    /// 输入值不能为空
    /// </summary>
    [ErrorCodeItemMetadata("输入值不能为空")]
    D0001,

    /// <summary>
    /// 输出值不能为空
    /// </summary>
    [ErrorCodeItemMetadata("输出值不能为空")]
    D0002,

    /// <summary>
    /// 类型不正确
    /// </summary>
    [ErrorCodeItemMetadata("类型不正确")]
    D0003,
    ...
    /// 用户未注册
    /// </summary>
    [ErrorCodeItemMetadata("用户未注册")]
    D1025,

    /// <summary>
    /// 输入的参数不能为空
    /// </summary>
    [ErrorCodeItemMetadata("输入的参数不能为空")]
    D1026,

    /// <summary>
    /// 请输入手机号
    /// </summary>
    [ErrorCodeItemMetadata("请输入手机号")]
    D1027,

    /// <summary>
    /// 请输入正确的手机号
    /// </summary>
    [ErrorCodeItemMetadata("请输入正确的手机号")]
    D1028,
    ...
    /// 文件名不能为空
    /// </summary>
    [ErrorCodeItemMetadata("上传文件名不能为空")]
    D8005,

    /// <summary>
    /// 文件名不能为空
    /// </summary>
    [ErrorCodeItemMetadata("上传文件不能为空")]
    D8006,
    ...
    /// 当前操作重复
    /// </summary>
    [ErrorCodeItemMetadata("当前操作重复")]
    P0001,

    /// <summary>
    /// 当前操作过期
    /// </summary>
    [ErrorCodeItemMetadata("当前操作过期")]
    P0002,

    /// <summary>
    /// 签名不正确
    /// </summary>
    [ErrorCodeItemMetadata("签名不正确")]
    P0003,
    ...
    /// 通过code获取微信token失败
    /// </summary>
    [ErrorCodeItemMetadata("通过code获取微信token失败")]
    W1000,

    /// <summary>
    /// 获取微信accessToken失败
    /// </summary>
    [ErrorCodeItemMetadata("获取微信accessToken失败")]
    W1001,

    /// <summary>
    /// 获取微信昵称头像失败
    /// </summary>
    [ErrorCodeItemMetadata("获取微信昵称头像失败")]
    W1002,

    /// <summary>
    /// 未关注微信公众号
    /// </summary>
    [ErrorCodeItemMetadata("未关注微信公众号")]
    W1003,

    /// <summary>
    /// 发送微信消息失败
    /// </summary>
    [ErrorCodeItemMetadata("发送微信消息失败")]
    W1004,
    /// <summary>
    /// 发送微信模板消息失败
    /// </summary>
    [ErrorCodeItemMetadata("发送微信模板消息失败")]
    W1005,
    /// <summary>
    /// 微信预付下单失败
    /// </summary>
    [ErrorCodeItemMetadata("微信预付下单失败")]
    W1006,
    /// <summary>
    /// 获取微信订单信息失败
    /// </summary>
    [ErrorCodeItemMetadata("获取微信订单信息失败")]
    W1007,
