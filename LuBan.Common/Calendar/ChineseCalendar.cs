...
*机器名称：WALLE
*公司名称：yswenli
*命名空间：LuBan.Common.Calendar
*文件名： ChineseCalendar
*版本号： V1.0.0.0
*唯一标识：9fea1ba3-630b-4761-b6ce-07979777b792
*当前的用户域：WALLE
*创建人： WALLE
*电子邮箱：yswenli@outlook.com
*创建时间：2023/2/14 17:19:11
*描述：中国农历
*
*=================================================
*修改标记
*修改时间：2023/2/14 17:19:11
*修改人： yswen
*版本号： V1.0.0.0
*描述：中国农历
*
...
namespace LuBan.Common.Calendar;
...
public class ChineseCalendar
{
    ...
    public static implicit operator ChineseCalendar(DateTime dateTime)
    {
        return new ChineseCalendar(dateTime);
    }
    /// <summary>
    /// 隐式转换
    /// </summary>
    /// <param name="chineseCalendar"></param>
    public static implicit operator DateTime(ChineseCalendar chineseCalendar)
    {
        return chineseCalendar._datetime;
    }
    ...
    /// <param name="t"></param>
    /// <returns></returns>
    public static ChineseCalendar operator +(ChineseCalendar d, TimeSpan t)
    {
        return d._datetime + t;
    }
    /// <summary>
    /// 减
    /// </summary>
    ...
    /// <param name="d2"></param>
    /// <returns></returns>
    public static TimeSpan operator -(ChineseCalendar d1, DateTime d2)
    {
        return d1._datetime - d2;
    }
    /// <summary>
    /// 减
    /// </summary>
    ...
    /// <param name="d2"></param>
    /// <returns></returns>
    public static bool operator ==(ChineseCalendar d1, ChineseCalendar d2)
    {
    ...
    /// <param name="t2"></param>
    /// <returns></returns>
    public static bool operator <(ChineseCalendar t1, ChineseCalendar t2)
    {
        return t1._datetime < t2._datetime;
    }
    /// <summary>
    /// 大于
    /// </summary>
